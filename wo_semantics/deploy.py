...
tf.app.flags.DEFINE_string('data_dir','/mnt/liguanlin/DataSets/iHarmony4/HAdobe5k/',
                           """Path to the dataset images""")#预测整体数据集需要配置的路径'/mnt/liguanlin/DataSets/iHarmony4/'
...
def inputs():
  ...
  path_truth = []
  if train:
    filename=os.path.join(FLAGS.data_dir,'IHD_noisy25_train.txt')
  else:
    filename=os.path.join(FLAGS.data_dir,'IHD_noisy25_test.txt')
